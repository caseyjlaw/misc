...
print 'Next local rising: ', ephem.localtime(obs.next_rising(src))
print 'Next local transit: ', ephem.localtime(obs.next_transit(src))
print 'Next local setting: ', ephem.localtime(obs.next_setting(src))
