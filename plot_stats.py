...
def compute():
    ...
    plt.text(26.8,12, 'JVLA', horizontalalignment='right',verticalalignment='center',fontsize=12,fontweight="bold", rotation='vertical')
    ...
    plt.title('Computational Demand for JVLA-like Array')
...
def plotfig(s=-1, num=-1, t=5):
    ...
    num = n.arange(3,65)
    sig_vla = 0.063 # 1 sigma, JVLA baseline sensitivity in 10 ms, 1 GHz, dual pol
